...
// Define Three.js elements as components to avoid JSX intrinsic element type errors
...
const MacroscopicWave = () => {
  ...
  return (
    <Torus ref={ref} args={[3, 0.1, 16, 100]} rotation={[Math.PI / 2, 0, 0]}>
      {/* Fix: Using component instead of intrinsic element to avoid JSX type error */}
  ...
  return (
    <div className="absolute inset-0 z-0 opacity-60 pointer-events-none">
      <Canvas camera={{ position: [0, 0, 6], fov: 45 }}>
        {/* Fix: Using AmbientLight component to avoid JSX type error */}
        <AmbientLight intensity={0.5} />
        {/* Fix: Using PointLight component to avoid JSX type error */}
  ...
  return (
    <div className="w-full h-full absolute inset-0">
      <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
        ...
        {/* Fix: Using SpotLight component to avoid JSX type error */}
